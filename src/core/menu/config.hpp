...
enum ConfigItemType { INT, BOOL, STR, COLOR };

namespace Config {
inline std::vector<std::string> cfgFiles;
inline char configFileName[128] = "wimor.cfg";
...
inline std::unordered_map<std::string_view, ConfigItem> config{
    ...
    CONFIGITEM("Rage>RageBot>Default>AutoShoot", false),
    CONFIGITEM("Rage>RageBot>Default>AutoShootKey", 0),
    CONFIGITEM("Rage>RageBot>Default>AutoShootMode", 0), // 0 = Hold, 1 = Toggle
    CONFIGITEM("Rage>RageBot>Default>MinDamage", 1),
    CONFIGITEM("Rage>RageBot>Default>Hitboxes", 31), // All hitboxes enabled by default (HEAD|NECK|CHEST|STOMACH|PELVIS = 0b11111)
    CONFIGITEM("Rage>RageBot>Default>TargetSelection", 0),
    CONFIGITEM("Rage>RageBot>Default>DMMode", false),
    CONFIGITEM("Rage>RageBot>Default>AutoPeek", false),
    CONFIGITEM("Rage>RageBot>Default>AutoPeekKey", 0),
    CONFIGITEM("Rage>RageBot>Default>AutoPeekColor", ImColor(255, 0, 0, 150)),
    ...
    CONFIGITEM("Visuals>Players>Enemies>Skeleton Color",
               ImColor(255, 255, 255, 255)),
    CONFIGITEM("Visuals>Players>Enemies>Name", false),
    CONFIGITEM("Visuals>Players>Enemies>Health", false),
    CONFIGITEM("Visuals>Players>Enemies>Health Bar Color",
               ImColor(0, 240, 0, 255)),
    ...
    CONFIGITEM("Visuals>Players>Enemies>Wall Penetration", false),
    CONFIGITEM("Visuals>Players>Enemies>Wall Penetration Color", ImColor(255, 255, 0, 150)),

    CONFIGITEM("Visuals>Players>Teammates>Box", false),
    CONFIGITEM("Visuals>Players>Teammates>Box Color",
               ImColor(10, 161, 32, 255)),
    CONFIGITEM("Visuals>Players>Teammates>Skeleton", false),
    CONFIGITEM("Visuals>Players>Teammates>Skeleton Color",
               ImColor(255, 255, 255, 255)),
    CONFIGITEM("Visuals>Players>Teammates>Name", false),
    CONFIGITEM("Visuals>Players>Teammates>Health", false),
    CONFIGITEM("Visuals>Players>Teammates>Health Bar Color",
               ImColor(0, 240, 0, 255)),
    ...
    CONFIGITEM("Visuals>Players>Enemies>Chams>Visible Color",
               ImColor(197, 66, 245, 255)),
    ...
    CONFIGITEM("Visuals>Players>Enemies>Chams>Visible Overlay Color",
               ImColor(197, 66, 245, 255)),
    CONFIGITEM("Visuals>Players>Enemies>Chams>Visible Overlay Wireframe",
               false),
    CONFIGITEM("Visuals>Players>Enemies>Chams>Occluded Material", 0),
    CONFIGITEM("Visuals>Players>Enemies>Chams>Occluded Color",
               ImColor(197, 66, 245, 255)),
    CONFIGITEM("Visuals>Players>Enemies>Chams>Backtrack Material", 0),
    CONFIGITEM("Visuals>Players>Enemies>Chams>Backtrack Color",
               ImColor(197, 66, 245, 255)),
    CONFIGITEM("Visuals>Players>Enemies>Chams>Trail", false),

    CONFIGITEM("Visuals>Players>Teammates>Chams>Visible Material", 0),
    CONFIGITEM("Visuals>Players>Teammates>Chams>Visible Color",
               ImColor(197, 66, 245, 255)),
    ...
    CONFIGITEM("Visuals>Players>Teammates>Chams>Visible Overlay Color",
               ImColor(197, 66, 245, 255)),
    CONFIGITEM("Visuals>Players>Teammates>Chams>Visible Overlay Wireframe",
               false),
    CONFIGITEM("Visuals>Players>Teammates>Chams>Occluded Material", 0),
    CONFIGITEM("Visuals>Players>Teammates>Chams>Occluded Color",
               ImColor(197, 66, 245, 255)),

    CONFIGITEM("Visuals>Players>LocalPlayer>Weapon Material", 0),
    CONFIGITEM("Visuals>Players>LocalPlayer>Weapon Color",
               ImColor(197, 66, 245, 255)),
    ...
    CONFIGITEM("Visuals>Players>LocalPlayer>Weapon Overlay Color",
               ImColor(197, 66, 245, 255)),
    ...
    CONFIGITEM("Visuals>Players>LocalPlayer>Arms Color",
               ImColor(197, 66, 245, 255)),
    ...
    CONFIGITEM("Visuals>Players>LocalPlayer>Arms Overlay Color",
               ImColor(197, 66, 245, 255)),
    ...
    CONFIGITEM("Visuals>Players>LocalPlayer>Sleeve Color",
               ImColor(197, 66, 245, 255)),
    ...
    CONFIGITEM("Visuals>Players>LocalPlayer>Sleeve Overlay Color",
               ImColor(197, 66, 245, 255)),
    ...
    CONFIGITEM(
        "Visuals>Players>LocalPlayer>Recoil Crosshair>Only When Shooting",
        false),
    CONFIGITEM("Visuals>Players>LocalPlayer>Crosshair Color",
               ImColor(0, 0, 0, 100)),
    CONFIGITEM("Visuals>Players>LocalPlayer>Crosshair Border Color",
               ImColor(200, 200, 200, 100)),

    CONFIGITEM("Visuals>World>World>World Color Modulation",
               ImColor(255, 255, 255, 255)),
    CONFIGITEM("Visuals>World>World>SkyBox Color Modulation",
               ImColor(255, 255, 255, 255)),
    ...
    CONFIGITEM("Visuals>World>World>Third Person While Scoped", false),
    ...
    CONFIGITEM("Visuals>World>Items>Fish Box Color",
               ImColor(255, 255, 255, 255)),
    ...
    CONFIGITEM("Misc>Misc>Movement>Fast Stop", false),
    CONFIGITEM("Misc>Misc>Movement>Speed Indicator", false),
    CONFIGITEM("Misc>Misc>Movement>EdgeBug Highlight", false),
    CONFIGITEM("Misc>Misc>Movement>EdgeBug Highlight Always", false),
    CONFIGITEM("Misc>Misc>Movement>EdgeBug Finder", false),
    CONFIGITEM("Misc>Misc>Movement>Auto Strafe Right", false),
    CONFIGITEM("Misc>Misc>Movement>Auto Strafe Right Key", 0),
    CONFIGITEM("Misc>Misc>Movement>Auto Strafe Left", false),
    CONFIGITEM("Misc>Misc>Movement>Auto Strafe Left Key", 0),
    ...
    CONFIGITEM("Misc>Skins>Knife Model", 0),
...
inline void save() {
  ...
  for (auto i : config) {
    ...
    case INT:
      configFile << i.second.type << "\t" << i.first << "\t"
                 << i.second.intValue << "\n";
      break;
    case BOOL:
      configFile << i.second.type << "\t" << i.first << "\t"
    ...
    case COLOR:
      configFile << i.second.type << "\t" << i.first << "\t"
                 << i.second.colValue.Value.x << "|"
                 << i.second.colValue.Value.y << "|"
                 << i.second.colValue.Value.z << "|"
                 << i.second.colValue.Value.w << "\n";
      break;
    }
  }
  configFile.close();
...
inline void load() {
  ...
  while (std::getline(configFile, line)) {
    ...
    try {
      ...
      case COLOR:
        float r, g, b, a;
        sscanf(value, "%f|%f|%f|%f", (float *)&r, (float *)&g, (float *)&b,
               (float *)&a);
      ...
      Log::log(ERR,
               "Failed to load config item %s, probably due to an out of date "
               "config, just redo the selected item and save again.",
               name);
    }
  }
}
...
inline void remove() {
  std::vector<std::string>::iterator itr =
      std::find(cfgFiles.begin(), cfgFiles.end(), configFileName);
